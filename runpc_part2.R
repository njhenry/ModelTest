...
runpc.last <- function(obsDat, locs, times , alpha, test.index, G_0 = NULL, supprMessages = FALSE, nSample = length(obsDat[[1]]),
  ...
  # print("o")
  # print(obsDatpw)
  pc <- pcalg.last(obsDat.n, alpha, test.index, G_0 = G_0, supprMessages = supprMessages)
  if(plotgraph){
    library(graph)
    pcmat <- pc
